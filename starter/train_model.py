...
def slice_inference(data, features, model, encoder, lb):
    ...
    for feature in features:
        for value in data[feature].unique():
            ...
            X, y, _, __ = process_data(
                subset, categorical_features=features, training=False, encoder=encoder, lb=lb, label="salary")
...
if __name__ == "__main__":
    ...
    X_test, y_test, encoder, lb = process_data(
        test, categorical_features=cat_features, training=False, encoder=encoder, lb=lb, label="salary")
